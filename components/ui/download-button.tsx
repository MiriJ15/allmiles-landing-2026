...
function GooglePlayIcon() {
  return (
    <svg viewBox="0 0 64 64" aria-hidden="true" className="h-[18px] w-[18px]">
      <path
        d="M8 6.5L35.8 32L8 57.5C6.9 56.8 6 55.4 6 53.8V10.2C6 8.6 6.9 7.2 8 6.5z"
        fill="#34A853"
      />
      <path
        d="M35.8 32L44.9 40.3L13.8 57.9C12.3 58.8 10.1 58.5 8 57.5L35.8 32z"
        fill="#FBBC04"
      />
      <path
        d="M35.8 32L13.8 6.1C15.7 5 17.9 4.8 19.5 5.8L44.9 23.7L35.8 32z"
        fill="#4285F4"
      />
      <path
        d="M44.9 23.7L50.2 27.4C53.9 30 53.9 34 50.2 36.6L44.9 40.3L35.8 32L44.9 23.7z"
        fill="#EA4335"
      />
    </svg>
  );
